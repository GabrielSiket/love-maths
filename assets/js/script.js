 ...
 * and after the user's has been processed
 */
function runGame(gameType) {
    // create two random numberts between 1 and 25
...
/**
 * gets the tally of incorrect aswers from the dom and increments it by 1
 */
